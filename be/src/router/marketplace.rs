...
use crate::{
    controller::v1::marketplace::{
        ...
        admin_moderate_provider_blog_post, admin_moderate_provider_profile,
        ...
        provider_create_image, provider_get_profile, provider_update_blog_post,
...
pub fn build_protected_marketplace_router(state: Arc<ServerState>) -> Router<Arc<ServerState>> {
    Router::new()
        ...
        .route(
            "/marketplace/provider/blog/{provider_blog_post_id}",
            put(provider_update_blog_post),
        )
        ...
        .route(
            "/marketplace/admin/providers/{provider_profile_id}/moderation",
            post(admin_moderate_provider_profile),
        )
        .route(
            "/marketplace/admin/provider-blog/{provider_blog_post_id}/moderation",
            post(admin_moderate_provider_blog_post),
        )
