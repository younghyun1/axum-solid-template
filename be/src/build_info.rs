...
pub const BUILD_TIME_UTC: &str = "2026-05-03T08:03:50.203895717+00:00";
pub const RUSTC_VERSION: &str = "rustc 1.97.0-nightly (20de910db 2026-05-02)";
pub const LIB_VERSIONS: [LibVersion; 33] = [
    LibVersion {
        name: "argon2",
        version: "0.5.3",
    },
